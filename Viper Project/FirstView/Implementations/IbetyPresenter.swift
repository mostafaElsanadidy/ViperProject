...
extension IbetyPresenter:ViewToPresenterProtocol{
    ...
    func viewWillAppear() {
        updateUserDefaults(value: "FirstViewController", key: "PAGENAME" , byKey: "IsEnterBackGround" )
        
        updateIfEnterBackground()
    }
    ...
    func showLanguageScreen() {
        router?.insertThirdViewControllerInTabBar(controllerName: "ThirdTabViewController1", in: myDetailsIndex, indexOfPage: 1)
    ...
    func drawPathLine(by frame: CGRect, mainFrame: CGRect){
        ...
        x1 = mainFrame.origin.x + mainFrame.width - 5
    ...
    func loginIn() {
        ...
        router?.initiate_PresentViewController(controllerName: "Login1ViewController")
    }
